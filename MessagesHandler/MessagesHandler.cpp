...
INT WINAPI _tWinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPTSTR lpszCmdLine, int nCmdShow)
{
	...
	hWnd = CreateWindowEx(
		...
		TEXT("Left Click"),	// заголовок окна
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	...
	switch (uMessage) {
		case WM_LBUTTONDOWN:
		{
			switch (lMessageCount) {
				case 0:
					{
						wsprintf(str, TEXT("Age: 18"));
						MessageBox(hWnd, TEXT(str), TEXT("Age"), MB_OK | MB_ICONINFORMATION);
						break;
					}
				case 1: 
					{
						wsprintf(str, TEXT("Name: noname"));
						MessageBox(hWnd, TEXT(str), TEXT("Name"), MB_OK | MB_ICONINFORMATION);
					}
					break;
				case 2:
					{
						wsprintf(str, TEXT("S_Name: noname"));
						MessageBox(hWnd, TEXT(str), TEXT("S_Name"), MB_OK | MB_ICONINFORMATION);
						break;
					}
				case 3:
					{
						LONG rez = (lCharCount / 3);
						wsprintf(str,TEXT("%d"), rez);
						MessageBox(hWnd, TEXT(str), TEXT("Result"), MB_OK | MB_ICONINFORMATION);
						break;
					}
					
			}
			lMessageCount++;
			lCharCount += strlen(str);
			break;
		}
		case WM_DESTROY:
			PostQuitMessage(0);
